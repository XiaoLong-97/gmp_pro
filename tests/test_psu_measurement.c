...
STATIC_ASSERT(hundred_milliamp_feedback_centi,
              PSU_ADC_IOUT_CENTIMA_FROM_COUNTS(2482U) == 10001U);
...
STATIC_ASSERT(current_full_scale_centi,
              PSU_ADC_IOUT_CENTIMA_FROM_COUNTS(4095U) == 16500U);
